...
public interface BitSliceIndex {
    ...
    void merge(BitSliceIndex other);
    ...
    RoaringBitmap distinct(@Nullable RoaringBitmap foundSet);
    ...
    default long countDistinct() {
        return countDistinct(null);
    }

    default RoaringBitmap distinct() {
